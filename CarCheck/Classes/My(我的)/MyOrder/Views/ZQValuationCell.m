...
@interface ZQValuationCell()<UITextViewDelegate,YPutPictureViewDelegate,YOrderEvaluteFootViewDelegate>
...
-(UIView *)backV{
    if (!_backV) {
        _backV = [[UIView alloc]initWithFrame:CGRectMake(0, 7, __kWidth, 235-38-80)];
...
//        _goodIV = [[UIImageView alloc]initWithFrame:CGRectMake(10, 20, 88, 88)];
        _goodIV = [[UIImageView alloc]initWithFrame:CGRectMake(10, 20, 0, 88)];
...
//        _inputTV = [[UITextView alloc]initWithFrame:CGRectMake(CGRectXW(_goodIV)+10, 24, __kWidth-120, 80)];
        _inputTV = [[UITextView alloc]initWithFrame:CGRectMake(CGRectXW(_goodIV)+10, 24, __kWidth-20, 80)];
...
-(YOrderEvaluteFootView *)footV{
    if (!_footV) {
        ...
        _footV = [[YOrderEvaluteFootView alloc]initWithFrame:CGRectMake(0, CGRectYH(_goodIV), __kWidth, 50)];
